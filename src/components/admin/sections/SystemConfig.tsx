  ...
  return (
    <div className="space-mobile">
      <div className="mb-6 sm:mb-8">
        <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold">System Configuration</h1>
        <p className="text-sm sm:text-base text-muted-foreground mt-1">Manage feature flags and system settings</p>
      </div>
