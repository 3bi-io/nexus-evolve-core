...
export const publicHeaderNavItems: NavItem[] = [
  ...
  { to: "/about", icon: Users, label: "About", description: "About Oneiros" },
];
...
export const navSections: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/xai-dashboard", icon: Sparkles, label: "XAI Dashboard" },
      { to: "/xai-studio", icon: Sparkles, label: "XAI Studio" },
      { to: "/xai-analytics", icon: BarChart3, label: "XAI Analytics" },
      { to: "/automation-hub", icon: Zap, label: "Automation Hub" },
